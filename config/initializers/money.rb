...
MoneyRails.configure do |config|
  ...
  # config.add_rate "CAD", "USD", 0.803115
    config.add_rate "USD", "CAD", 1.35360
    config.add_rate "USD", "EUR", 0.92
    config.add_rate "USD", "SGD", 1.35
    config.add_rate "USD", "CNY", 7.29
    config.add_rate "USD", "AUD", 1.55
    config.add_rate "USD", "MYR", 4.64
    config.add_rate "USD", "JPY", 145.85
    config.add_rate "USD", "VND", 24097  
